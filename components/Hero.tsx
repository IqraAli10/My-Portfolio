            ...
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
                    ...
                    <p className="text-center text-white-100 md:tracking-wider mb-4 text-sm md:text-2xl">
                        Hey, I'm Iqra!
                        A frontend developer and UI/UX designer, I specialize in building sleek, user-friendly interfaces that bring ideas to life. Let’s craft something beautiful together
                    </p>
                    <a href="#about">
                      <MagicButton
                      title="Show my work"
